...
namespace os_project
{
    public partial class Form3 : Form
    {
        ...
        void drawsenceFirstFit()
        {
            ...
            { SolidBrush b = new SolidBrush(Color.Brown);
              g.FillRectangle(b, Form2.instance.par[i].x, Form2.instance.par[i].y, Form2.instance.par[i].w, Form2.instance.par[i].h);
                ...
                if(Form2.instance.par[i].n != Form2.instance.par[i].nn)
                    g.DrawString(Form2.instance.par[i].nn + "", new Font("system", 20), Brushes.Orange, Form2.instance.par[i].x + Form2.instance.par[i].w / 2 - 10, Form2.instance.par[i].y + Form2.instance.par[i].h +20);
            ...
            if(Prowait.Count>0)
            {
                g.DrawString("Processes Must Wait: ", new Font("system", 20), Brushes.Red, 20, y);
                y += 30;
                for (int i = 0; i < Prowait.Count; i++)
                {
                    g.DrawString(Prowait[i].n + "", new Font("system", 20), Brushes.Yellow, 20, y);
                    y += 30;
                }
            }
